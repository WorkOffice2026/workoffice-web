...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-[#111] font-sans">
      ...
      {/* HEADER */}
      <header className="flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 lg:px-12 py-4 sm:py-6 border-b bg-white sticky top-0 z-50 gap-4">
        <a href="#inicio">
          <Image
        ...
        <nav className="flex flex-wrap justify-center gap-3 sm:gap-6 md:gap-10 text-xs sm:text-sm font-medium text-gray-600">
      ...
      <section
        id="inicio"
        className="relative min-h-[100vh] sm:min-h-[85vh] flex items-center justify-center overflow-hidden"
      >
        <video
          autoPlay
          muted
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-3xl">
          <motion.h2
            ...
            className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-snug sm:leading-tight"
          >
          ...
          <motion.p
            ...
            className="mt-4 sm:mt-6 text-sm sm:text-lg md:text-xl text-gray-200 max-w-xl mx-auto"
          >
      ...
      {/* NOSOTROS */}
      <section id="nosotros" className="bg-white px-4 sm:px-6 lg:px-12 py-20 max-w-6xl mx-auto">
      ...
      {/* VALORES */}
      <section className="bg-[#216089] px-4 sm:px-6 lg:px-12 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {["Experiencia", "Confidencialidad", "Vocación", "Compromiso"].map((v) => (
              <div
                key={v}
                className="bg-white rounded-full px-4 sm:px-6 py-3 sm:py-4 text-center font-semibold text-[#216089]"
              >
                {v}
              </div>
            ))}
      ...
      {/* EQUIPO */}
      <section className="bg-white px-4 sm:px-6 lg:px-12 py-20 max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        <div>
      ...
      {/* SERVICIOS */}
      <section id="servicios" className="px-4 sm:px-6 lg:px-12 py-20 bg-white max-w-6xl mx-auto">
        ...
        <div className="flex flex-col gap-4">
          {["Selección de Personal", "Temporarios", "Payroll"].map((s) => (
            <div key={s} className="bg-[#216089] text-white rounded-full px-6 py-4 text-center">
              {s}
            </div>
          ))}
        </div>
      ...
      {/* VACANTES */}
      <section id="vacantes" className="px-4 sm:px-6 lg:px-12 py-20 bg-gray-50">
      ...
      {/* CONTACTO */}
      <section id="contacto" className="px-4 sm:px-6 lg:px-12 py-20">
        <h3 className="text-3xl font-bold text-center mb-10 text-[#216089]">
          Contacto
        </h3>
      ...
      {/* FOOTER */}
      <footer className="bg-[#216089] text-white px-4 sm:px-6 lg:px-12 py-12">
